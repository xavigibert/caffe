...
int main(int argc, char** argv) {
  ...
  gflags::SetUsageMessage("This script converts the FRA/Amtrak dataset to\n"
        ...
        "The Fasteners dataset could be downloaded at\n"
        "    http://www.umiacs.umd.edu/~gibert/wacv15/amtrak_fasteners.tar\n"
        "You should untar them after downloading,"
        "or directly use data/fasteners/get_fasteners.sh\n");
  ...
  if( argc < 2 ) {
    gflags::ShowUsageWithFlagsRestrict(argv[0],
        "examples/fasteners/convert_fasteners_data");
    return 0;
  }
